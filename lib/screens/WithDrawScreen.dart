                                  ...
                                  children: [
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        SizedBox(height: 4),
                                        Text(printAmount(data.amount!.toStringAsFixed(digitAfterDecimal)), style: secondaryTextStyle(size: 12)),
                                      ],
                                    )
                                  ],
                                ),
        ...
        child: Padding(
          ...
          child: AppButtonWidget(
            ...
            onTap: () {
              ...
              if(widget.bankInfo.accountNumber.validate().isEmpty || widget.bankInfo.bankCode.validate().isEmpty || widget.bankInfo.bankName.validate().isEmpty || widget.bankInfo.accountHolderName.validate().isEmpty){
